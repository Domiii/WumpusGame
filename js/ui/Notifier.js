 ...
 * This is implicitly used by NotificationList.
 * @constructor
 */
var Notification = function(message, title, closeOnClick, timeOutMillis, iconUrl) {
    var notificationElement = this.notificationElement = createNotificationElement();

    if (iconUrl) {
        // add icon element
        var iconElement = this.iconElement = $("<img/>");
    ...
    if (closeOnClick) {
        notificationElement.bind("click", (function(self) { return function() {
            if (self.list) {
                self.list.removeNotification(self);
            }
        }; })(this));
...
/**
 * Creates a new NotificationList that holds and allows managing of pretty notifications in your UI.
 *
 * @param {Object} config
 * @param {Element} [config.containerElement] The container element that holds this list.
 */
...
NotificationList.prototype = {
     /**
      * Creates, adds and returns a new Notification.
      * @return The created Notification object.
      */
    addNotification : function(message, title, closeOnClick, timeOutMillis, iconUrl) {
        var notification = new Notification(message, title, closeOnClick, timeOutMillis, iconUrl);
    ...
    /**
     * Called when the given notification has been clicked.
     */
    ...
    error : function(message, title, closeOnClick, timeOutMillis) {
