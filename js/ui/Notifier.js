 ...
 * @constructor
 */
var Notification = function(message, title, iconUrl, timeOut) {
...
NotificationList.prototype = {
      ...
      */
    addNotification : function(message, title, iconUrl, timeOutMillis) {
        var notification = new Notification(message, title, iconUrl, timeOutMillis);
